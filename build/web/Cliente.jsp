<%-- 
    Document   : Cliente
    Created on : 17/07/2022, 12:17:05 p. m.
    Author     : is-da
--%>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>${cl.getEstado()}</td>
                            <td>
                                <a class="btn btn-warning" href="Controlador1?menu=Cliente&accion=Editar&id=${cl.getId()}">Editar</a>
                                <a class="btn btn-danger" href="Controlador1?menu=Cliente&accion=Delete&id=${cl.getId()}">Delete</a>
                            </td>
                        </tr>
                        </c:forEach>
                    </tbody>
